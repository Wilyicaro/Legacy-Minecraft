...
public interface ContainerEventHandlerMixin extends GuiEventListener {
    ...
    @Shadow @Nullable ComponentPath nextFocusPathInDirection(ScreenRectangle screenRectangle, ScreenDirection screenDirection, @Nullable GuiEventListener guiEventListener, FocusNavigationEvent focusNavigationEvent);

    @Shadow void setFocused(@Nullable GuiEventListener guiEventListener);
    ...
    private ComponentPath handleArrowNavigation(FocusNavigationEvent.ArrowNavigation arrowNavigation) {
        ...
        if (guiEventListener == null) {
            ...
            return path == null ? null : path.component() == guiEventListener ? null : ComponentPath.path((ContainerEventHandler) this, path);
        }
    }
