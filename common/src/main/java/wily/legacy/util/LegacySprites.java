...
public class LegacySprites {
    ...
    public static final ResourceLocation BANNER_SLOT = new ResourceLocation(Legacy4J.MOD_ID,"container/banner_slot");
    public static final ResourceLocation DYE_SLOT = new ResourceLocation(Legacy4J.MOD_ID,"container/dye_slot");
    public static final ResourceLocation PATTERN_SLOT = new ResourceLocation(Legacy4J.MOD_ID,"container/pattern_slot");
    ...
    public static final ResourceLocation UNSELECT_HIGHLIGHTED = new ResourceLocation(Legacy4J.MOD_ID,"transferable_list/unselect_highlighted");
    public static final ResourceLocation UNSELECT = new ResourceLocation(Legacy4J.MOD_ID,"transferable_list/unselect");
    ...
    public static final ResourceLocation EXPERIENCE_BAR_BACKGROUND = new ResourceLocation(Legacy4J.MOD_ID,"container/experience_bar_background");
    public static final ResourceLocation EXPERIENCE_BAR_CURRENT = new ResourceLocation(Legacy4J.MOD_ID,"container/experience_bar_current");
    ...
    public static final ResourceLocation JOIN_HIGHLIGHTED = new ResourceLocation(Legacy4J.MOD_ID,"server_list/join_highlighted");
    public static final ResourceLocation JOIN = new ResourceLocation(Legacy4J.MOD_ID,"server_list/join");
    public static final ResourceLocation MOVE_UP_HIGHLIGHTED = new ResourceLocation(Legacy4J.MOD_ID,"server_list/move_up_highlighted");
    public static final ResourceLocation MOVE_UP = new ResourceLocation(Legacy4J.MOD_ID,"server_list/move_up");
    public static final ResourceLocation MOVE_DOWN_HIGHLIGHTED = new ResourceLocation(Legacy4J.MOD_ID,"server_list/move_down_highlighted");
    public static final ResourceLocation MOVE_DOWN = new ResourceLocation(Legacy4J.MOD_ID,"server_list/move_down");
    public static final ResourceLocation TRANSFER_MOVE_UP_HIGHLIGHTED = new ResourceLocation(Legacy4J.MOD_ID,"transferable_list/move_up_highlighted");
    public static final ResourceLocation TRANSFER_MOVE_UP = new ResourceLocation(Legacy4J.MOD_ID,"transferable_list/move_up");
    public static final ResourceLocation TRANSFER_MOVE_DOWN_HIGHLIGHTED = new ResourceLocation(Legacy4J.MOD_ID,"transferable_list/move_down_highlighted");
    public static final ResourceLocation TRANSFER_MOVE_DOWN = new ResourceLocation(Legacy4J.MOD_ID,"transferable_list/move_down");
    public static final ResourceLocation TEXT_FIELD = new ResourceLocation(Legacy4J.MOD_ID,"widget/text_field");
    public static final ResourceLocation HIGHLIGHTED_TEXT_FIELD = new ResourceLocation(Legacy4J.MOD_ID,"widget/text_field_highlighted");
    public static final ResourceLocation HIGHLIGHTED_SLIDER = new ResourceLocation(Legacy4J.MOD_ID,"widget/slider_highlighted");;
    public static ResourceLocation SLIDER = new ResourceLocation(Legacy4J.MOD_ID,"widget/slider");
    public static ResourceLocation SLIDER_HANDLE_HIGHLIGHTED = new ResourceLocation(Legacy4J.MOD_ID,"widget/slider_handle_highlighted");
    public static ResourceLocation SLIDER_HANDLE = new ResourceLocation(Legacy4J.MOD_ID,"widget/slider_handle");
