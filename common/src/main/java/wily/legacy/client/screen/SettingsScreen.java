...
public class SettingsScreen extends RenderableVListScreen {
    ...
    protected SettingsScreen(Screen parent) {
        ...
        renderableVList.addRenderable(openScreenButton(Component.translatable("legacy.menu.game_options"), ()-> prepareGameOptionsScreen(new PanelVListScreen(this,250,182,Component.translatable("legacy.menu.game_options"),minecraft.options.autoJump(),minecraft.options.bobView(),((LegacyOptions)minecraft.options).flyingViewRolling(),((LegacyOptions)minecraft.options).unfocusedInputs(),minecraft.options.toggleCrouch(),minecraft.options.toggleSprint(),((LegacyOptions)minecraft.options).hints(),((LegacyOptions)minecraft.options).displayNameTagBorder(),((LegacyOptions)minecraft.options).autoSaveInterval(),((LegacyOptions)minecraft.options).autoSaveWhenPaused(),((LegacyOptions)minecraft.options).directSaveLoad(),((LegacyOptions)minecraft.options).legacyCreativeBlockPlacing(),((LegacyOptions)minecraft.options).cursorMode(),minecraft.options.sensitivity(),minecraft.options.realmsNotifications(), minecraft.options.allowServerListing()),minecraft)).build());
        ...
        renderableVList.addRenderable(openScreenButton(Component.translatable("legacy.menu.user_interface"),()-> prepareUserInterfaceScreen(new PanelVListScreen(this,250,200,Component.translatable("legacy.menu.user_interface"),((LegacyOptions)minecraft.options).displayHUD(),((LegacyOptions)minecraft.options).displayHand(),minecraft.options.showAutosaveIndicator(),((LegacyOptions)minecraft.options).showVanillaRecipeBook(),((LegacyOptions)minecraft.options).tooltipBoxes(),((LegacyOptions)minecraft.options).selectedControlIcons(),minecraft.options.attackIndicator(),((LegacyOptions)minecraft.options).hudScale(),((LegacyOptions)minecraft.options).hudOpacity(),((LegacyOptions)minecraft.options).hudDistance(),((LegacyOptions)minecraft.options).inGameTooltips(),((LegacyOptions)minecraft.options).legacyItemTooltips(),((LegacyOptions)minecraft.options).vignette(),((LegacyOptions)minecraft.options).animatedCharacter(),((LegacyOptions)minecraft.options).smoothAnimatedCharacter(),((LegacyOptions)minecraft.options).interfaceSensitivity(),((LegacyOptions)minecraft.options).classicCrafting(), ((LegacyOptions)minecraft.options).legacyCreativeTab(),((LegacyOptions)minecraft.options).vanillaTabs(), ((LegacyOptions)minecraft.options).searchCreativeTab(), minecraft.options.operatorItemsTab(), minecraft.options.narrator(), minecraft.options.showSubtitles(), minecraft.options.highContrast(), minecraft.options.notificationDisplayTime(), minecraft.options.damageTiltStrength(), minecraft.options.glintSpeed(), minecraft.options.glintStrength(), minecraft.options.hideLightningFlash(), minecraft.options.darkMojangStudiosBackground(), minecraft.options.panoramaSpeed(),minecraft.options.chatVisibility(), minecraft.options.chatColors(), minecraft.options.chatLinks(), minecraft.options.chatLinksPrompt(),  minecraft.options.backgroundForChatOnly(), minecraft.options.chatOpacity(), minecraft.options.textBackgroundOpacity(), minecraft.options.chatScale(), minecraft.options.chatLineSpacing(), minecraft.options.chatDelay(), minecraft.options.chatWidth(), minecraft.options.chatHeightFocused(), minecraft.options.chatHeightUnfocused(), minecraft.options.narrator(), minecraft.options.autoSuggestions(), minecraft.options.hideMatchedNames(), minecraft.options.reducedDebugInfo(), minecraft.options.onlyShowSecureChat()))).build());
    ...
    public PanelVListScreen prepareGraphicsScreen(Function<Assort.Selector,PanelVListScreen> builder){
        ...
        screen.renderableVList.addOptions(0,new OptionInstance<>("options.fullscreen.resolution", OptionInstance.noTooltip(), (component, integer) -> {
            if (monitor == null) {
                ...
                return integer == -1 ? Options.genericValueLabel(component, Component.translatable("options.fullscreen.current")) : Options.genericValueLabel(component, Component.literal(monitor.getMode(integer).toString()));
            }
        }, new OptionInstance.IntRange(-1, monitor != null ? monitor.getModeCount() - 1 : -1), j, (integer) -> {
            if (monitor != null) {
                Minecraft.getInstance().getWindow().setPreferredFullscreenVideoMode(integer == -1 ? Optional.empty() : Optional.of(monitor.getMode(integer)));
            }
        }));
