...
public class OptionsScreen extends PanelVListScreen {
    ...
    public void addControlTooltips(ControlTooltip.Renderer renderer) {
        ...
        renderer.add(()-> advancedOptionsScreen == null || getFocused() instanceof Assort.Selector ? null : ControlType.getActiveType().isKbm() ? ControlTooltip.getKeyIcon(InputConstants.KEY_O) : ControllerBinding.UP_BUTTON.bindingState.getIcon(), ()-> ControlTooltip.getAction("legacy.action.show_advanced_options"));
    }
