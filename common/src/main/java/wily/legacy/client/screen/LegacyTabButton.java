...
public class LegacyTabButton extends AbstractButton {
    public static final ResourceLocation[][] SPRITES = new ResourceLocation[][]{new ResourceLocation[]{ResourceLocation.fromNamespaceAndPath(Legacy4J.MOD_ID, "tiles/high_tab_left"),ResourceLocation.fromNamespaceAndPath(Legacy4J.MOD_ID, "tiles/low_tab_left")}, new ResourceLocation[]{ResourceLocation.fromNamespaceAndPath(Legacy4J.MOD_ID, "tiles/high_tab_middle"),ResourceLocation.fromNamespaceAndPath(Legacy4J.MOD_ID, "tiles/low_tab_middle")}, new ResourceLocation[]{ResourceLocation.fromNamespaceAndPath(Legacy4J.MOD_ID, "tiles/high_tab_right"),ResourceLocation.fromNamespaceAndPath(Legacy4J.MOD_ID, "tiles/low_tab_right")},
                                                                                new ResourceLocation[]{ResourceLocation.fromNamespaceAndPath(Legacy4J.MOD_ID, "tiles/high_vert_tab_up"),ResourceLocation.fromNamespaceAndPath(Legacy4J.MOD_ID, "tiles/low_vert_tab_up")}, new ResourceLocation[]{ResourceLocation.fromNamespaceAndPath(Legacy4J.MOD_ID, "tiles/high_vert_tab_middle"),ResourceLocation.fromNamespaceAndPath(Legacy4J.MOD_ID, "tiles/low_vert_tab_middle")}, new ResourceLocation[]{ResourceLocation.fromNamespaceAndPath(Legacy4J.MOD_ID, "tiles/high_vert_tab_down"),ResourceLocation.fromNamespaceAndPath(Legacy4J.MOD_ID, "tiles/low_vert_tab_down")}};
