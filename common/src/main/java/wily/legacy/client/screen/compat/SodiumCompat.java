...
public class SodiumCompat {
    ...
    public static final OptionsScreen.Section SODIUM = OptionsScreen.Section.add(new OptionsScreen.Section(Component.literal(Legacy4JPlatform.getModInfo("sodium").getName()), s-> Panel.centered(s, 220, optionsButtons.size()*24+16), new ArrayList<>(List.of(o-> optionsButtons.forEach(s-> o.getRenderableVList().addRenderable(s.apply(o)))))));
