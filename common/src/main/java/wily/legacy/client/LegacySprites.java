...
public class LegacySprites {
    ...
    public static final ResourceLocation MOVE_UP_SPRITE = new ResourceLocation("server_list/move_up");
    public static final ResourceLocation MOVE_DOWN_HIGHLIGHTED_SPRITE = new ResourceLocation("server_list/move_down_highlighted");
    public static final ResourceLocation MOVE_DOWN_SPRITE = new ResourceLocation("server_list/move_down");
    public static final ResourceLocation TRANSFER_MOVE_UP_HIGHLIGHTED_SPRITE = new ResourceLocation("transferable_list/move_up_highlighted");
    public static final ResourceLocation TRANSFER_MOVE_UP_SPRITE = new ResourceLocation("transferable_list/move_up");
    public static final ResourceLocation TRANSFER_MOVE_DOWN_HIGHLIGHTED_SPRITE = new ResourceLocation("transferable_list/move_down_highlighted");
    public static final ResourceLocation TRANSFER_MOVE_DOWN_SPRITE = new ResourceLocation("transferable_list/move_down");
