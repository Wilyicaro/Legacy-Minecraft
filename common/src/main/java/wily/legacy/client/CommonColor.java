...
public class CommonColor extends Stocker<Integer> {
    ...
    public static final CommonColor CHAT_BACKGROUND = registerCommonColor("chat_background",0x383838);
    public static final CommonColor INVENTORY_GRAY_TEXT = registerCommonColor("inventory_gray_text", 0x383838);
    public static final CommonColor WIDGET_TEXT = registerCommonColor("widget_text", 0xFFFFFF);
    public static final CommonColor HIGHLIGHTED_WIDGET_TEXT = registerCommonColor("highlighted_widget_text", 0xFFFFFF);
