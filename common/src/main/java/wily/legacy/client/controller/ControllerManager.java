...
public  class ControllerManager {
    ...
    public static void updatePlayerCamera(BindingState.Axis stick, Controller handler){
        ...
        if ((!ScreenUtil.getLegacyOptions().controllerUnfocusedInput().get() && !minecraft.mouseHandler.isMouseGrabbed() || !minecraft.isWindowActive()) || !stick.pressed || minecraft.player == null) return;
