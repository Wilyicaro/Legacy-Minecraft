...
public interface CommonNetwork {
    ...
    record PacketHandler(ResourceLocation id, Packet commonPacket) implements Packet,CustomPacketPayload{
    ...
    interface PayloadRegister {
        <T extends CustomPacketPayload> void register(boolean client, ResourceLocation id, Function<FriendlyByteBuf, T> codec, Consumer<T> apply);
    }
