...
public record ServerInventoryCraftPacket(List<Ingredient> ingredients, ItemStack result, int button, boolean max) implements CommonPacket{
    public ServerInventoryCraftPacket(RegistryFriendlyByteBuf buf){
        this(buf.readList(i->Ingredient.CONTENTS_STREAM_CODEC.decode((RegistryFriendlyByteBuf) i)), ItemStack.STREAM_CODEC.decode(buf),buf.readVarInt(), buf.readBoolean());
    }
    ...
    public void encode(RegistryFriendlyByteBuf buf) {
        buf.writeCollection(ingredients,(r,i)->Ingredient.CONTENTS_STREAM_CODEC.encode((RegistryFriendlyByteBuf) r,i));
