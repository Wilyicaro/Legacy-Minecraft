...
public class LegacyCommonOptions {
    ...
    public static final FactoryConfig<Boolean> legacySkeletonHorseRiding = COMMON_STORAGE.register(FactoryConfig.createBoolean("legacySkeletonHorseRiding", FactoryConfigDisplay.createToggle(optionName("legacySkeletonHorseRiding")), true, b -> {}, COMMON_STORAGE));
    public static final FactoryConfig<Boolean> villagerSpawnEggProfessions = COMMON_STORAGE.register(FactoryConfig.createBoolean("villagerSpawnEggProfessions", FactoryConfigDisplay.createToggle(optionName("villagerSpawnEggProfessions")), true, b -> {}, COMMON_STORAGE));
