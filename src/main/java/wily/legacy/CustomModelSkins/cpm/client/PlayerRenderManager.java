...
import wily.legacy.CustomModelSkins.cpm.mixin.access.HumanoidModelAccessor;
import wily.legacy.CustomModelSkins.cpm.mixin.access.ModelAccessor;
import wily.legacy.CustomModelSkins.cpm.mixin.access.PlayerModelAccessor;
...
public class PlayerRenderManager extends ModelRenderManager<Void, ModelTexture, ModelPart, Model> {
    ...
    public static abstract class RDH<M extends Model> extends ModelRenderManager.RedirectHolder<Model, Void, ModelTexture, ModelPart> {
        ...
        protected ModelPart getRoot() {
            return ((wily.legacy.CustomModelSkins.cpm.mixin.access.ModelAccessor) (Object) model()).cpm$getRoot();
        }

        protected void setRoot(ModelPart part) {
            ((wily.legacy.CustomModelSkins.cpm.mixin.access.ModelAccessor) (Object) model()).cpm$setRoot(part);
        }
