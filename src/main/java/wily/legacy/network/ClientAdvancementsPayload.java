...
/*?} else {*//*Map<ResourceLocation,Advancement.Builder> map*//*?}*/) implements CommonNetwork.Payload {
    ...
    public ClientAdvancementsPayload(CommonNetwork.PlayBuf buf) {
        this(/*? if >1.20.1 {*/buf.get().readList(b -> {
            return /*? if <1.20.5 {*//*AdvancementHolder.read(b)*//*?} else {*/new AdvancementHolder(b./*? if <1.21.11 {*//*readResourceLocation*//*?} else {*/readIdentifier/*?}*/(), Advancement.STREAM_CODEC.decode(buf.get()))/*?}*/;
    ...
    public void encode(CommonNetwork.PlayBuf buf) {
        ...
        buf.get().writeCollection(collection, (b, h) -> {
            ...
            /*h.write(b);
             *///?} else {
            b./*? if <1.21.11 {*//*writeResourceLocation*//*?} else {*/writeIdentifier/*?}*/(h.id());
