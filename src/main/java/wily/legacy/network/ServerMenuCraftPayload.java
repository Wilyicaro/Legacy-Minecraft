...
public record ServerMenuCraftPayload(Optional</*? if <1.21.11 {*//*ResourceLocation*//*?} else {*/Identifier/*?}*/> craftId, List<Optional<Ingredient>> customIngredients,
    ...
    public ServerMenuCraftPayload(CommonNetwork.PlayBuf buf) {
        this(buf.get().readOptional(FriendlyByteBuf::/*? if <1.21.11 {*//*readResourceLocation*//*?} else {*/readIdentifier/*?}*/), buf.get().readList(b -> buf.get().readOptional(b1 -> FactoryIngredient.decode(buf).toIngredient())), buf.get().readVarInt(), buf.get().readBoolean());
    }
    ...
    public void encode(CommonNetwork.PlayBuf buf) {
        buf.get().writeOptional(craftId, FriendlyByteBuf::/*? if <1.21.11 {*//*writeResourceLocation*//*?} else {*/writeIdentifier/*?}*/);
