...
public class LegacyCommonOptions {
    ...
    public static final FactoryConfig<Boolean> legacyCombat = COMMON_STORAGE.register(FactoryConfig.createBoolean("legacyCombat", new FactoryConfigDisplay.Instance<>(optionName("legacyCombat")), true, b -> {
    }, COMMON_STORAGE));
    public static final FactoryConfig<Boolean> legacySwordBlocking = COMMON_STORAGE.register(FactoryConfig.createBoolean("legacySwordBlocking", new FactoryConfigDisplay.Instance<>(optionName("legacySwordBlocking")), false, b -> {
    }, COMMON_STORAGE));
