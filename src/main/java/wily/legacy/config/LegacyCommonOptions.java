...
public class LegacyCommonOptions {
    ...
    public static final FactoryConfig<Boolean> legacyMapBehavior = COMMON_STORAGE.register(FactoryConfig.createBoolean("legacyMapBehavior", new FactoryConfigDisplay.Instance<>(optionName("legacyMapBehavior")), true, b-> {}, COMMON_STORAGE));
