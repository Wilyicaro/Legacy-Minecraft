...
public class LegacySprites {
    ...
    public static final ResourceLocation SKIN_TICK = Legacy4J.createModLocation("widget/skin_tick");
    ...
    public static final ResourceLocation SEARCH_SMALL = Legacy4J.createModLocation("icon/search");
