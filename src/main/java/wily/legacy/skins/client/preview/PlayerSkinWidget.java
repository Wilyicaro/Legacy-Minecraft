...
public class PlayerSkinWidget extends AbstractWidget {
    ...
    private static volatile ResourceLocation CENTER_NAME_PLATE_SPRITE = wily.factoryapi.FactoryAPI.createLocation("legacy", "tiles/skin_box");
    private static volatile ResourceLocation CENTER_SELECTED_BADGE_SPRITE = wily.factoryapi.FactoryAPI.createLocation("legacy", "tiles/tu3_selected");
    ...
    private void updateScaledSize() {
        ...
        //? if <=1.20.1 {
        /*((WidgetAccessor)this).setHeight(Math.round(originalHeight * scale));
        *///?} else {
    ...
    private void renderNamePlate(GuiGraphics guiGraphics, String id, int left, int right, int bottom) {
        ...
        FactoryGuiGraphics.of(guiGraphics).blitSprite(CENTER_NAME_PLATE_SPRITE, plateX, plateY, plateW, plateH);
        ...
        FactoryGuiGraphics.of(guiGraphics).blitSprite(CENTER_SELECTED_BADGE_SPRITE, badgeX, badgeY, badgeW, badgeH);
    ...
    private String themeLabel(String id, String label) {
        ...
        if (modelId == null) {
            ...
            ResourceLocation texture = entry != null && entry.texture() != null ? entry.texture() : wily.factoryapi.FactoryAPI.createLocation(ns, id);
