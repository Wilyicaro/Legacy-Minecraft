...
public class ChangeSkinScreen extends AbstractChangeSkinScreen {
    ...
    private void drawActionSprite(GuiGraphics guiGraphics, Identifier sprite, Bounds holder) {
    ...
    private static void blitSprite(GuiGraphics guiGraphics, Identifier sprite, Bounds bounds) {
