...
public final class GuiDollRender {
    ...
    private static void submit(GuiGraphicsExtractor gui, int left, int right, PreviewLayout layout, AvatarRenderState state) {
        ...
        gui.entity(state, layout.scale(), layout.translate(), layout.bodyRotation(), layout.cameraRotation(), left - horizontalPadding, layout.expandedTop(), right + horizontalPadding, layout.expandedBottom());
    }
