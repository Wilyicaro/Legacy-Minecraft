...
public record PlayerIdentifier(int index, Identifier optionsMapSprite, int color,
                               Identifier mapDecorationSprite, Identifier offMapDecorationSprite,
                               Identifier offLimitsMapDecorationSprite) {
    public static final Codec<PlayerIdentifier> CODEC = RecordCodecBuilder.create(i -> i.group(Codec.INT.fieldOf("index").forGetter(PlayerIdentifier::index), Identifier.CODEC.fieldOf("optionsMapSprite").orElse(LegacySprites.MAP_PLAYER).forGetter(PlayerIdentifier::optionsMapSprite), CommonColor.INT_COLOR_CODEC.fieldOf("color").orElse(0xFFFFFF).forGetter(PlayerIdentifier::color), Identifier.CODEC.fieldOf("mapDecorationSprite").orElse(MapDecorationTypes.PLAYER.value().assetId()).forGetter(PlayerIdentifier::mapDecorationSprite), Identifier.CODEC.fieldOf("offMapDecorationSprite").orElse(MapDecorationTypes.PLAYER_OFF_MAP.value().assetId()).forGetter(PlayerIdentifier::offMapDecorationSprite), Identifier.CODEC.fieldOf("offLimitsMapDecorationSprite").orElse(MapDecorationTypes.PLAYER_OFF_LIMITS.value().assetId()).forGetter(PlayerIdentifier::offLimitsMapDecorationSprite)).apply(i, PlayerIdentifier::new));
    ...
    public Identifier spriteByMapDecorationType(Holder<MapDecorationType> type) {
