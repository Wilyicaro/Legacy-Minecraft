...
public class CommonValue<T> extends Stocker<T> {
    public static final ListMap</*? if <1.21.11 {*//*ResourceLocation*//*?} else {*/Identifier/*?}*/, CommonValue<?>> COMMON_VALUES = new ListMap<>();
    ...
    public static <T> CommonValue<T> registerCommonValue(/*? if <1.21.11 {*//*ResourceLocation*//*?} else {*/Identifier/*?}*/ id, T defaultValue, Codec<T> codec) {
        return registerCommonValue(id, new CommonValue<>(defaultValue, codec));
    }

    public static <T> CommonValue<T> registerCommonValue(/*? if <1.21.11 {*//*ResourceLocation*//*?} else {*/Identifier/*?}*/ id, CommonValue<T> commonValue) {
