...
public record LegacyTipOverride(BiPredicate<Item, /*? if <1.20.5 {*//*CompoundTag*//*?} else {*/DataComponentPatch/*?}*/> matchItemOverride, Predicate<Block> matchBlockOverride, Predicate<EntityType<?>> matchEntityOverride, Component tip) {
    ...
    public static final LoadingCache<Pair<Item, /*? if <1.20.5 {*//*CompoundTag*//*?} else {*/DataComponentPatch/*?}*/>,Component> itemOverrideCache = CacheBuilder.newBuilder().build(new CacheLoader<>() {
        @Override
        public Component load(Pair<Item, /*? if <1.20.5 {*//*CompoundTag*//*?} else {*/DataComponentPatch/*?}*/> itemPair) {
    ...
    public static Component getOverride(ItemStack stack){
        return itemOverrideCache.getUnchecked(Pair.of(stack.getItem(),stack./*? if <1.20.5 {*//*getTag*//*?} else {*/getComponentsPatch/*?}*/()));
    }
