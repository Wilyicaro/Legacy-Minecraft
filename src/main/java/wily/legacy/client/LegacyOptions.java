...
public class LegacyOptions {
    ...
    public static final FactoryConfig<Boolean> fogAffectsClouds = CLIENT_STORAGE.register(createBoolean("fogAffectsClouds", true));
    public static final FactoryConfig<Boolean> legacyCloudHeight = CLIENT_STORAGE.register(createBoolean("legacyCloudHeight", true));
