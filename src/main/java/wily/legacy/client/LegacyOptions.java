...
public class LegacyOptions {
    ...
    public static final FactoryConfig<Boolean> lceClouds = CLIENT_STORAGE.register(FactoryConfig.createBoolean("lceClouds", FactoryConfigDisplay.createToggle(Component.literal("LCE Clouds")), true, b -> {
