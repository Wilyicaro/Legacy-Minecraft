...
import wily.legacy.client.screen.ControlTooltip.ActionHolder;
//?}
...
public record PackAlbum(String id, int version, Component displayName, Component description,
                        Optional</*? if <1.21.11 {*//*ResourceLocation*//*?} else {*/Identifier/*?}*/> iconSprite, Optional</*? if <1.21.11 {*//*ResourceLocation*//*?} else {*/Identifier/*?}*/> backgroundSprite,
                        List<String> packs, Optional<String> displayPack) {
    public static final Codec<PackAlbum> CODEC = RecordCodecBuilder.create(i -> i.group(Codec.STRING.fieldOf("id").forGetter(PackAlbum::id), Codec.INT.optionalFieldOf("version", 0).forGetter(PackAlbum::version), DynamicUtil.getComponentCodec().fieldOf("name").forGetter(PackAlbum::displayName), DynamicUtil.getComponentCodec().fieldOf("description").forGetter(PackAlbum::description), /*? if <1.21.11 {*//*ResourceLocation*//*?} else {*/Identifier/*?}*/.CODEC.optionalFieldOf("icon").forGetter(PackAlbum::iconSprite), /*? if <1.21.11 {*//*ResourceLocation*//*?} else {*/Identifier/*?}*/.CODEC.optionalFieldOf("background").forGetter(PackAlbum::backgroundSprite), Codec.STRING.listOf().fieldOf("packs").forGetter(PackAlbum::packs), Codec.STRING.optionalFieldOf("displayPack").forGetter(PackAlbum::displayPack)).apply(i, PackAlbum::new));
    ...
    public static PackAlbum registerDefaultResource(String id, int version, Component displayName, Component description, /*? if <1.21.11 {*//*ResourceLocation*//*?} else {*/Identifier/*?}*/ iconSprite, /*? if <1.21.11 {*//*ResourceLocation*//*?} else {*/Identifier/*?}*/ backgroundSprite, List<String> packs, String displayPack) {
    ...
    public static class Selector extends AbstractWidget implements ActionHolder {
        ...
        public static final /*? if <1.21.11 {*//*ResourceLocation*//*?} else {*/Identifier/*?}*/ DEFAULT_ICON = FactoryAPI.createVanillaLocation("textures/misc/unknown_pack.png");
        private static final Map<String, /*? if <1.21.11 {*//*ResourceLocation*//*?} else {*/Identifier/*?}*/> packIcons = Maps.newHashMap();
        private static final Map<String, /*? if <1.21.11 {*//*ResourceLocation*//*?} else {*/Identifier/*?}*/> packBackgrounds = Maps.newHashMap();
        ...
        public static /*? if <1.21.11 {*//*ResourceLocation*//*?} else {*/Identifier/*?}*/ loadPackIcon(TextureManager textureManager, Pack pack, String icon, /*? if <1.21.11 {*//*ResourceLocation*//*?} else {*/Identifier/*?}*/ fallback) {
            try (PackResources packResources = pack.open()) {
                /*? if <1.21.11 {*//*ResourceLocation*//*?} else {*/Identifier/*?}*/ resourceLocation;
                {
                    IoSupplier<InputStream> ioSupplier = packResources.getRootResource(icon);
                    if (ioSupplier == null)
                        return fallback;
                    String string = pack.getId();
                    /*? if <1.21.11 {*//*ResourceLocation*//*?} else {*/Identifier/*?}*/ resourceLocation3 = FactoryAPI.createLocation("minecraft", icon + "/" + Util.sanitizeName(string, /*? if <1.21.11 {*//*ResourceLocation*//*?} else {*/Identifier/*?}*/::validPathChar) + "/" + Hashing.sha1().hashUnencodedChars(string) + "/icon");
        ...
        public static /*? if <1.21.11 {*//*ResourceLocation*//*?} else {*/Identifier/*?}*/ getPackIcon(Pack pack) {
        ...
        public static /*? if <1.21.11 {*//*ResourceLocation*//*?} else {*/Identifier/*?}*/ getPackBackground(Pack pack) {
        ...
        public void renderTooltipBox(GuiGraphics graphics, int x, int y, int width, int height) {
            ...
            if (getSelectedAlbum() != null) {
                ...
                *///?} else {
                MultiLineLabel nameLabel = (sd ? sdLabelsCache : labelsCache).apply(getSelectedAlbum().displayName(), nameWidth);
                ActiveTextCollector textCollector = graphics.textRenderer(); nameLabel.visitLines(TextAlignment.LEFT, x + (sd ? 40 : 43), y + 8, lineHeight, textCollector);
                //?}
                graphics.disableScissor();
                /*? if <1.21.11 {*//*ResourceLocation*//*?} else {*/Identifier/*?}*/ background = getSelectedAlbum().backgroundSprite.orElse(p ? getPackBackground(packRepository.getPack(getSelectedAlbum().getDisplayPackId())) : null);
