...
public class MixedCraftingScreen<T extends AbstractCraftingMenu> extends RecipesScreen<T, RecipeIconHolder<MixedCraftingScreen.VanillaCrafting>> implements TabList.Access {
    public static final /*? if <1.21.11 {*//*ResourceLocation*//*?} else {*/Identifier/*?}*/ STRUCTURES_TAB = Legacy4J.createModLocation("structures");
    public static final /*? if <1.21.11 {*//*ResourceLocation*//*?} else {*/Identifier/*?}*/ MECHANISMS_TAB = Legacy4J.createModLocation("mechanisms");
    public static final /*? if <1.21.11 {*//*ResourceLocation*//*?} else {*/Identifier/*?}*/ TOOLS_TAB = Legacy4J.createModLocation("tools");
    public static final /*? if <1.21.11 {*//*ResourceLocation*//*?} else {*/Identifier/*?}*/ MISC_TAB = Legacy4J.createModLocation("misc");
    public static final /*? if <1.21.11 {*//*ResourceLocation*//*?} else {*/Identifier/*?}*/ SEARCH_TAB = Legacy4J.createModLocation("search");
    ...
    protected void updateRecipes() {
        /*? if <1.21.11 {*//*minecraft = Minecraft.getInstance();*//*?}*/
