...
public class LegacyScrollRenderer {
    public static final /*? if <1.21.11 {*//*ResourceLocation*//*?} else {*/Identifier/*?}*/[] SCROLLS = new /*? if <1.21.11 {*//*ResourceLocation*//*?} else {*/Identifier/*?}*/[]{LegacySprites.SCROLL_UP, LegacySprites.SCROLL_DOWN, LegacySprites.SCROLL_LEFT, LegacySprites.SCROLL_RIGHT};
    ...
    public void renderScroll(GuiGraphics graphics, ScreenDirection direction, int x, int y, /*? if <1.21.11 {*//*ResourceLocation*//*?} else {*/Identifier/*?}*/ sprite, int width, int height) {
