...
public class PlayGameScreen extends PanelVListScreen implements ControlTooltip.Event, TabList.Access {
    ...
    public void renderableVListInit() {
        getRenderableVList().init(panel.x + 15,panel.y + 15,270, panel.height - 30 - (tabList.getIndex() == 0 ? 21 : 0));
        if (!hasTabList()) serverRenderableList.init("serverRenderableVList",panel.x + 15,panel.y + 15,270, panel.height - 30 - (tabList.getIndex() == 0 ? 21 : 0));
    }
    ...
    public void renderDefaultBackground(GuiGraphics guiGraphics, int i, int j, float f) {
        ...
        FactoryGuiGraphics.of(guiGraphics).blitSprite(LegacySprites.PANEL_RECESS, accessor.getInteger("panelRecess.x",panel.x + 9), accessor.getInteger("panelRecess.y",panel.y + 9), accessor.getInteger("panelRecess.width",panel.width - 18), accessor.getInteger("panelRecess.height",panel.height - 18 - (tabList.getIndex() == 0 ? 21 : 0)));
        if (hasTabList() && tabList.getIndex() == 0){
