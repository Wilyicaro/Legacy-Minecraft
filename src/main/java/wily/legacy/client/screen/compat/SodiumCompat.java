...
public class SodiumCompat {
    ...
    public static <T> void applyChangesStatefulOption(StatefulOption<T> option) {
        ConfigManager.CONFIG.applyOption((Identifier) ReflectionUtil.getFieldValue(SODIUM_OPTION_FIELDS.get("id"), option));
    }
