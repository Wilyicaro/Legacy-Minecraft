...
public class LegacyLanguageScreen extends PanelVListScreen {
    ...
    protected void init() {
        ...
        addRenderableOnly(((guiGraphics, i, j, f) -> LegacyRenderUtil.renderPanelRecess(accessor, guiGraphics, "panelRecess", panel.x + 6, panel.y + 24, panel.width - 12, panel.height - 34)));
