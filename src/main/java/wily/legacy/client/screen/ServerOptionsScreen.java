...
public class ServerOptionsScreen extends ConfirmationScreen{
    ...
    protected void addButtons() {
        ...
        renderableVList.addRenderable(Button.builder(JoinGameScreen.JOIN_GAME, b-> minecraft.setScreen(new JoinGameScreen(parent, serverData, b1 -> parent.serverRenderableList.join(serverData)))).build());
        renderableVList.addRenderable(Button.builder(Component.translatable("manageServer.edit.title"),b-> minecraft.setScreen(new ServerEditScreen(parent, serverData,false))).build());
