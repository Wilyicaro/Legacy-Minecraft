...
public class LegacyLoadingRenderer implements Renderable {
    ...
    public void renderForeground(GuiGraphics guiGraphics, int i, int j, float f) {
        ...
        ArbitrarySupplier</*? if <1.21.11 {*//*ResourceLocation*//*?} else {*/Identifier/*?}*/> fontOverride = accessor.getElement("fontOverride", /*? if <1.21.11 {*//*ResourceLocation*//*?} else {*/Identifier/*?}*/.class);
