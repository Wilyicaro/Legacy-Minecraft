...
public class PatchNotesScreen extends PanelBackgroundScreen {
    public static final /*? if <1.21.11 {*//*ResourceLocation*//*?} else {*/Identifier/*?}*/ NEWER_VERSION = Legacy4J.createModLocation("ui_definitions/newer_version_notes.json");
    public static final /*? if <1.21.11 {*//*ResourceLocation*//*?} else {*/Identifier/*?}*/ NEWER_MINECRAFT_VERSION = FactoryAPI.createVanillaLocation("ui_definitions/newer_version_notes.json");
    protected final ScrollableRenderer scrollableRenderer = new ScrollableRenderer();
    private final /*? if <1.21.11 {*//*ResourceLocation*//*?} else {*/Identifier/*?}*/ uiDefinitionID;

    public PatchNotesScreen(Screen parent, /*? if <1.21.11 {*//*ResourceLocation*//*?} else {*/Identifier/*?}*/ uiDefinitionID) {
