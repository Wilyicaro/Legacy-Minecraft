...
public record LegacyBiomeOverride(/*? if <1.21.11 {*//*ResourceLocation*//*?} else {*/Identifier/*?}*/ id, Optional<Component> name, Optional<ItemStack> item,
    ...
    public LegacyBiomeOverride(/*? if <1.21.11 {*//*ResourceLocation*//*?} else {*/Identifier/*?}*/ id) {
    ...
    public static LegacyBiomeOverride getOrDefault(Optional<ResourceKey<Biome>> optionalKey) {
        return optionalKey.isEmpty() ? getDefault() : getOrDefault(optionalKey.get()./*? if <1.21.11 {*//*location*//*?} else {*/identifier/*?}*/());
    }

    public static LegacyBiomeOverride getOrDefault(/*? if <1.21.11 {*//*ResourceLocation*//*?} else {*/Identifier/*?}*/ location) {
