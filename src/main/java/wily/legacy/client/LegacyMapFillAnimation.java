...
public class LegacyMapFillAnimation {
    ...
    private static Object mapId;
    private static Object pendingMapId;
    ...
    public static void start(Object id, boolean reusedMap) {
        pendingMapId = id;
        pendingReusedMap = reusedMap;
        mapId = null;
    }

    public static void track(Object state, Object id, MapItemSavedData data) {
    ...
    public static boolean isColumnVisible(Object state, int x) {
    ...
    public static byte[] colors(Object state) {
        State stateData = STATES.get(state);
        if (stateData == null || !isActive(stateData.mapId())) return null;
        return stateData.colors();
    }

    private static boolean isActive(Object id) {
        return id != null && id.equals(mapId) && Util.getMillis() - startTime < DURATION;
    }

    private static void startWhenReady(Object id, MapItemSavedData data) {
    ...
    private record State(Object mapId, byte[] colors) {
    }
}
