...
public abstract class GuiGraphicsMixin {
    ...
    private void renderTooltipInternal(Font font, List<ClientTooltipComponent> list, int i, int j, ClientTooltipPositioner clientTooltipPositioner, /*? if <1.21.11 {*//*ResourceLocation*//*?} else {*/Identifier/*?}*/ location/*? if forge || neoforge {*//*, ItemStack tooltipStack*//*?}*/, CallbackInfo ci) {
