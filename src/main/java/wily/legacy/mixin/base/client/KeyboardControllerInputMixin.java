...
public class KeyboardControllerInputMixin extends ClientInput {
    ...
    private Vec2 normalize(Vec2 instance, Operation<Vec2> original) {
        return Legacy4JClient.controllerManager.isControllerTheLastInput() && (LegacyControlsOptions.forceSmoothMovement.get() || Legacy4JClient.hasModOnServer()) ? instance : original.call(instance);
    }
}
