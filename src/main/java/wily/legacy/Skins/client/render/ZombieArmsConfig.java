...
public final class ZombieArmsConfig {
    ...
    static {
        ...
        d.add("cpm:legacy_skinpacks:skinpacks/halloween_charity/thegrimreaper4jstudios.cpmmodel");
        d.add("cpm:legacy_skinpacks:skinpacks/halloween_charity/greggthegrimreaperrare.cpmmodel");
        ...
        d.add("cpm:legacy_skinpacks:skinpacks/halloween_mashup/greggthegrimreaper.cpmmodel");
        d.add("cpm:legacy_skinpacks:skinpacks/halloween_mashup/thegrimreaper.cpmmodel");
