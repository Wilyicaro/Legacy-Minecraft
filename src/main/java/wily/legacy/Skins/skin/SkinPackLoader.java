...
public final class SkinPackLoader {
    ...
    private static final ResourceLocation DEFAULT_CPM_PREVIEW_SKIN = ResourceLocation.fromNamespaceAndPath(SkinSync.ASSET_NS, "skinpacks/default/skins/steve.png");
    ...
    public static void loadPacks(ResourceManager rm) {
        ...
        boolean allowCpm = Legacy4J.INTERNAL_CPM_ENABLED;
        ...
        try {
            ...
            for (Map.Entry<ResourceLocation, Resource> e : jsons.entrySet()) {
                ...
                if (!SkinIds.PACK_DEFAULT.equals(packId) && SkinSync.ASSET_NS.equals(ns)) continue;

                JsonObject json = readObj(e.getValue());
                if (json != null) loadSinglePack(ns, packId, json, rm, packs, skinsById, packBySkin, allowCpm);
            }

            loadLegacySkinPacksIndex(rm, packs, skinsById, packBySkin, allowCpm);
        } catch (Throwable ex) {
    ...
    private static void loadLegacySkinPacksIndex(ResourceManager rm,
        ...
        for (String ns : rm.getNamespaces()) {
            if (SkinSync.ASSET_NS.equals(ns)) continue;
            ...
            try {
                ...
                for (Map.Entry<String, JsonElement> pe : root.entrySet()) {
                    ...
                    if (!allowCpm && type != null && type.equalsIgnoreCase("cpm")) continue;
    ...
    private static void loadSinglePack(String namespace, String packId, JsonObject json, ResourceManager rm,
        ...
        if (skins != null) {
            for (int i = 0; i < skins.size(); i++) {
                ...
                if (!allowCpm && SkinIdUtil.isCpm(skinId)) continue;
