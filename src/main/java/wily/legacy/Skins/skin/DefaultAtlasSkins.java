...
public final class DefaultAtlasSkins {
    ...
    private static final ResourceLocation ATLAS_PNG = ResourceLocation.fromNamespaceAndPath(SkinSync.ASSET_NS, "skinpacks/default/default_atlas.png");
    private static final ResourceLocation ATLAS_JSON = ResourceLocation.fromNamespaceAndPath(SkinSync.ASSET_NS, "skinpacks/default/default_atlas.json");
    ...
    public static boolean isDefaultAtlasDyn(ResourceLocation id) {
        return id != null && SkinSync.ASSET_NS.equals(id.getNamespace()) && id.getPath().startsWith("dyn/default/");
    }
    ...
    public static ResourceLocation getTexture(ResourceManager rm, String texPath) {
        ...
        Frame fr = frames.get(frame);
        if (fr == null) {
            return ResourceLocation.fromNamespaceAndPath(SkinSync.ASSET_NS, "skinpacks/default/" + texPath);
        }
        try {
            ResourceLocation loc = ResourceLocation.fromNamespaceAndPath(SkinSync.ASSET_NS, "dyn/default/" + frame);
